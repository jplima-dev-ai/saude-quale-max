...
assert json.loads((root/"data/config.json").read_text(encoding="utf-8"))["versao"]=="3.5.9"
assert 'qualimax-v3.5.9' in (root/"service-worker.js").read_text(encoding="utf-8")
print(f"v3.5.9 OK: {len(pages)} páginas com camada para leitores de tela")
