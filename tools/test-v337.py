...
if cfg.get("versao")!="3.5.0": errors.append("versão incorreta")
...
if "qualimax-v3.5.0" not in sw or "max-intelligence.js" not in sw: errors.append("cache v3.5.0 incompleto")
