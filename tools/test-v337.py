...
if cfg.get("versao")!="3.5.4": errors.append("versão incorreta")
...
if "qualimax-v3.5.4" not in sw or "max-intelligence.js" not in sw: errors.append("cache v3.5.4 incompleto")
