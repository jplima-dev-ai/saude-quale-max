...
assert config["versao"]=="3.5.4"
assert routes["version"]=="3.5.4"
...
assert "admin-products-v350.js" in sw and "qualimax-v3.5.4" in sw
print("v3.5.4 OK: central profissional de produtos integrada")
