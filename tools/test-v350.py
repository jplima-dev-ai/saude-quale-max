...
assert config["versao"]=="3.5.0"
assert routes["version"]=="3.5.0"
...
assert "admin-products-v350.js" in sw and "qualimax-v3.5.0" in sw
print("v3.5.0 OK: central profissional de produtos integrada")
