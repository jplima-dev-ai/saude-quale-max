(() => {
    ...
    const contextoPagina = (produtos=[]) => {
        ...
        if(arquivo==="conta.html") return {tipo:"conta"};
        if(arquivo==="atendimento.html") return {tipo:"atendimento"};
        if(arquivo==="contato.html") return {tipo:"contato"};
        if(arquivo==="sobre.html") return {tipo:"sobre"};
        return {tipo:"home"};
    };
