...
const criarCard = (produto, rotulo="") => {
    ...
    if(arq){ img.src=`assets/images/thumbs/${arq}`; img.alt=""; img.loading="lazy"; img.addEventListener("error",()=>img.remove());}
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    if(window.QualimaxDB){
        ...
        if(wa && numero && listaProds.length){
            wa.href="support.html?origem=conta&assunto=Fazer%20um%20pedido";
