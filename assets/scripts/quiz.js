class QuizInterativo {
    ...
    renderizarIndisponivel() {
        this.container.innerHTML = `
            <section class="quiz-card" role="status" aria-labelledby="quiz-indisponivel-titulo">
                ...
                <p><a class="botao botao-principal" href="catalog.html#produtos">Explorar catálogo</a></p>
            </section>
        `;
    }
    ...
    mostrarResultado() {
        ...
        if (whatsapp && numero) {
            ...
            whatsapp.href = "support.html?origem=quiz&assunto=Tirar%20d%C3%BAvida%20sobre%20produtos";
        ...
        return `
            <article class="quiz-produto-card" role="listitem">
                <div class="quiz-produto-imagem">
                    <img
                        src="assets/images/thumbs/${this.nomeArquivoSeguro(produto.imagem)}"
